...
def _set_via_width(via: Any, width_nm: int) -> None:
    """Set via width safely across KiCad 8, 9 and 10."""
    try:
        via.SetWidth(pcbnew.F_Cu, int(width_nm))
        via.SetWidth(pcbnew.B_Cu, int(width_nm))
    except (TypeError, AttributeError):
        via.SetWidth(int(width_nm))
...
class RoutingCommands:
    ...
    def add_via(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            _set_via_width(via, int(size * 1000000) if size else design_settings.GetCurrentViaSize())
    ...
    def copy_routing_pattern(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for via in vias_to_copy:
                ...
                _set_via_width(new_via, _via_front_width(via))
    ...
    def _do_add_gnd_stitching(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not dry_run:
            ...
            for cx, cy in placed_via_centres:
                ...
                _set_via_width(via, via_size_nm)
