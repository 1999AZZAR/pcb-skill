...
class DynamicSymbolLoader:
    ...
    def _supports_kicad10_symbol_tokens(cls, content: str) -> bool:
        ...
        Default to KiCad 9 (False) when version is unknown or absent to guarantee
        that emitted schematics remain 100% compatible with KiCad 9.
        """
        version = cls._read_sch_version(content)
        return version is not None and version >= _KICAD10_SCH_VERSION
