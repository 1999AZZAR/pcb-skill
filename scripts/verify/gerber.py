...
def parse_excellon(text, name="?"):
    ...
    """
    plated = ("TYPE=PLATED" in text[:400] or "Plated" in text[:400]
              or "PTH" in text[:400] or "MixedPlating" in text[:400])
    tools, hits = {}, []
    cur = None
    ...
    for line in text.split("\n"):
        ...
        if not line or line.startswith(";"):
            continue
        if line in ("%", "M48", "M30", "M95", "G05", "G90", "G91") or line.startswith("FMAT"):
            continue
